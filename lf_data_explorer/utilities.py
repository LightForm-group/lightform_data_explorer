...
def output_network_json(all_samples: List[Sample]):
    ...
    with open("lf_data_explorer/static/graphs/graph_data.js", "w") as output_file:
        output_file.write("//This file is automatically generated by the 'output_network_json' "
                          "function of the lightform_data_explorer. Do not edit this file "
                          "manually as it will be overwritten.\n")
